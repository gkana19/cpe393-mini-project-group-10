 ...
 *
 *                              NFT Contract
 * Author: Group 10 | LoneCac
 * StudentID1: 63070501048
 * StudentID1: 63070501087
 * StudentID1: 63070501090
 * ContractName: LoneCac
 *
 **********************************************************************************
 */

contract LoneCac is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "LoneCac: not owner");
        _;
    }
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "LoneCac: not exist");
